  ...
  return (
    <section className="screen">
      ...
      <p className="screen__hint">
        ...
        по бокам немного больше, но не шире 43:18; экраны уже — ровно этот участок с полосами сверху
        и снизу. Чем больше значение, тем дальше камера и тем раньше видно подлетающих врагов. Кадр
        применяется со следующего запуска боя, допустимый диапазон — от {CAMERA_VIEW_WIDTH_MIN} до{" "}
        {CAMERA_VIEW_WIDTH_MAX}.
      </p>
      ...
      <p className="screen__hint">
        Туманность и три слоя звёзд под ареной. Параллакс умножает скорость, с которой небо уходит
        против камеры: туманность медленнее всех, ближние звёзды быстрее всех, при нуле небо стоит.
        «Без фона» — пустой космос, самый лёгкий вариант для слабых телефонов. Применяется со
