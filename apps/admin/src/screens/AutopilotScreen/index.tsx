    ...
    <section className="screen">
      <header className="screen__header">
        ...
        <p className="screen__hint">
          Эти числа влияют на игру. По ним ведёт бой не только демонстрация: комната ими же ведёт
          любое место, на котором нет живого игрока — сектор щита в соло и на двоих, и место
          отвалившегося игрока, пока он не вернулся. Уровень и профиль читаются на старте прогона,
          поэтому идущий бой правку не подхватывает.
        </p>
      </header>
