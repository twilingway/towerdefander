...
export function HullCard({
  ...
  return (
    <article className="card">
      ...
      <h4 className="card__subtitle">Эффекты корпуса</h4>
      <p className="screen__hint">
        Барьер — это то, чем нарисован поднятый сектор; вспышка играется там, где щит остановил
        снаряд; уничтожение — то, во что превращается корпус; выстрел — вспышка на дуле турели.
        Выбор идёт с корпусом, поэтому за прогон он не меняется. «Как сейчас» оставляет запечённые
        эффекты дисплея — ровно то, что видел любой пресет до появления слотов.
      </p>
      <ShieldEffectSlots
