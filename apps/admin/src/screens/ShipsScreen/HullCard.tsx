  ...
  return (
    <article className="card">
      ...
      <p className="screen__hint">
        ...
        снаряд; уничтожение — то, во что превращается корпус. Выбор идёт с корпусом, поэтому за
        прогон он не меняется. «Как сейчас» оставляет запечённые эффекты дисплея — ровно то, что
        видел любой пресет до появления слотов.
      </p>
      <ShieldEffectSlots
