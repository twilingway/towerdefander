  ...
  return (
    <details className="legend">
      ...
      <dl className="legend__list">
        ...
        <dt>Мастерство</dt>
        <dd>
          какой профиль с вкладки «ИИ врага» ведёт этот тип: упреждение, задержка реакции, разброс,
          развод по кругу и отход подранка. Разброс между типами задаёте вы — перехватчик может быть
          новичком, а босс асом
        </dd>
        <dt>Очки / Кредиты</dt>
        <dd>
