...
/**
 * The music this screen is played under: one theme, a list played in turn, or
 * null for silence.
 *
 ...
 */
export function useMusicTrack(tracks: MusicTrackId | readonly MusicTrackId[] | null): void {
  useEffect(() => {
    audioBus().playMusic(tracks ?? undefined);
  }, [tracks]);
}
