...
import { dynamicEntityCount, type FlyingCastleState } from "@town-defenders/game-core";
import { PLAYER_CAPACITY, PROTOCOL_VERSION } from "@town-defenders/protocol";
...
import { TownDefendersState } from "./TownDefendersState.js";
...
describe("TownDefendersRoom cap traffic", () => {
...
function startGame(): { readonly room: TownDefendersRoom; readonly controllers: TestClient[] } {
...
function envelope(room: TownDefendersRoom, client: TestClient) {
  return {
    protocolVersion: PROTOCOL_VERSION,
    roomId: room.roomId,
...
function schemaEntityCount(state: TownDefendersState): number {
