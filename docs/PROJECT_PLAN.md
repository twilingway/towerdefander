...
Статус: базовый профиль утверждён 27 июля 2026 года; bootstrap завершён, network-first vertical
slice реализован и ожидает проверки с физическим телефоном в локальной сети.
