...
пяти-волновый цикл двух секторов и первый художественный проход центрального замка завершены.
Игровой цикл проходит unit, network smoke и browser E2E и готов к ручной балансировке.
