...
Статус: базовый профиль утверждён 27 июля 2026 года; bootstrap, network-first vertical slice и
первый игровой цикл двух секторов завершены. Этап игрового ядра проходит unit, network smoke и
browser E2E и готов к ручной балансировке.
