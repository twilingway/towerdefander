...
- [ ] 1.5 Проверить `docker/web.Dockerfile` по прецеденту `fx-assets`: собирается ли дисплей без
...
- [ ] 5.3 `node scripts/bench-panels.mjs --cpu=4` на волне со спрайтами против `main`: кадр не хуже
- [ ] 5.4 Ручная приёмка оператором: размер корпуса-спрайта против круга поражения, враги-спрайты,
