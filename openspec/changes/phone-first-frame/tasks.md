...
- [x] 4.4 Экраны уже 19.5:9: участок той же площади до 16:9 (`CAMERA_VIEW_NARROWEST_ASPECT`), уже —
      полосы сверху и снизу; юнит-тесты, `viewport.spec.ts`, снимки
...
- [x] 5.2 Стики и кнопки у краёв экрана с safe area; нажимаемое не меньше 44 px и не ближе 16 px к
      краю
- [x] 5.3 Снимки кампании и матча на 15 размерах после правок; аудит Codex; исправления по нему

Проверка: снимки `live-*` на всех размерах без ошибок страницы; сравнение с «до».

## 6. Тесты e2e и документы

- [x] 6.1 `viewport.spec.ts`: оси полос на 1920×1080 и 3440×1440, телефон 19.5:9 без полос
- [x] 6.2 `shieldGlow.spec.ts`: эталон без полос 19.5:9, комментарии о полосах
