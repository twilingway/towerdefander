...
### Requirement: Legacy flying-castle capability retired
...
**Reason**: Replaced by the SpaceShip Defender identity and spaceship simulation. **Migration**: Use
`spaceship-simulation` and protocol v10 `game.spaceship`.
