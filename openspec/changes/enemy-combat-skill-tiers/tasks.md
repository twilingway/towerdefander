...
- [ ] 3.1 Провести `moveEnemy` через профиль: полоса смешивания и доля облёта из ручек, дистанция
      боя растёт на `retreatStandoffFactor` ниже `retreatHpFraction`. Разлипание у обода не трогать.
- [ ] 3.2 Добавить восприятие с задержкой `reactionTicks` и экстраполяцию запомненного между
      снимками.
- [ ] 3.3 Добавить расталкивание и разведение по секторам. Проверка: тест на рой из одного архетипа
      — ни одна пара не ближе суммы радиусов, пеленги различны.
- [ ] 3.4 Добавить уклонение от дружественных снарядов в горизонте `evadeHorizonTicks`.
- [ ] 3.5 Провести проход стрельбы через упреждение и разброс из seeded потока (`deriveDomainSeed` +
